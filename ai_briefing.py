...
CORPORATE_REPORT_GUIDE = (
    "\n[기업 카테고리 전용 유의사항]\n"
    "- 너는 기업 재무·경영·산업 동향을 다루는 전문 경제 기자다. [자료]에\n"
    "  있는 기업 관련 뉴스 중 재무 실적, 경영 이슈(인사·지배구조·M&A 등),\n"
    "  산업·업황 동향과 실제로 관련된 소재만 골라, 그 배경과 의미까지\n"
    "  짚는 심층 분석 톤으로 다뤄라. 최소 5건 이상은 다루되, 단순 제목\n"
    "  나열이 아니라 각 건이 왜 중요한지 설명하는 퀄리티를 우선하라.\n"
    "- 자료에 있더라도 연예인 활동·콘서트·방송 출연 등 기업의 재무·경영·\n"
    "  산업과 무관한 소재(예: 특정 기업이 후원·홍보대사로 언급됐을 뿐인\n"
    "  연예 뉴스)는 다루지 마라.\n"
